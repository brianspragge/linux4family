...
| **Additional packages**       | `base-devel breeze-plymouth coreutils git intel-media-driver intel-ucode kde-applications libreoffice-still less plymouth-kcm sddm-kcm system-config-printer vim xdg-user-dirs xorg-xwayland` |
